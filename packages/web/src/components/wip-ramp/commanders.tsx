...
if ((Object.keys(myData).length === 0 && myData.constructor === Object) ) {
  return (
      <>
      <h1>
          Commander ID {commanderID} was not found.
      </h1>
      </>
  ) 
}
            ...
            <div>
                ...
                <Row>
                    ...
                    <Col style={{ padding: '0px 20px 0px 0px' }} flex="100px">
                        <img src="https://www.coh2.org/uploads/hosting/okw_icons/OKW_Special_Operations.jpg" width="130" height="169" />
                        <h2 style={{ textAlign:"center", margin: "-5px 0px 0px 0px"}}>{myData.races[0].toUpperCase()}</h2>
                    </Col>
                    <Col span={10}>
