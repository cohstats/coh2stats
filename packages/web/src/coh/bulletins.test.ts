...
describe("Search Bulletins Function test", () => {
  ...
  test("Find more than 1 bulletin by bulletin name", () => {
    ...
    const found = searchBulletins(searchQuery);
    expect(found.find((commander:any) => commander["bulletinName"] == "Missiles Everywhere!")).toBeTruthy();
    expect(found.find((commander:any) => commander["bulletinName"] == "Artillery Production I")).toBeTruthy();
  });
